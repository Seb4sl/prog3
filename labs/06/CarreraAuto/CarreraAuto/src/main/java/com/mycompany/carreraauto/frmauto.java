...
public class frmauto extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbl1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/carreraauto/luchio.png"))); // NOI18N

        lbl2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/carreraauto/vins.png"))); // NOI18N

        lbl3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/carreraauto/meu.png"))); // NOI18N

        lbl4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/mycompany/carreraauto/prueba.png"))); // NOI18N
